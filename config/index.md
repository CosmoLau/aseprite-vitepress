...
hero:
  ...
  actions:
    - theme: brand
      ...
      link: /{lang}/docs/overview
    - theme: alt
      text: API Reference
      link: /{lang}/api/README
    - theme: alt
...
<div>
    ...
    <div :class='$style.grid'>
        <div :class='$style.card'>
            ...
            <p><a href='/{lang}/docs/new-layer'>Create</a>, 
                <a href='/{lang}/docs/copy-layers'>Copy</a>, 
                <a href='/{lang}/docs/move-layers'>Move</a>, Drag & Delete<a href='/{lang}/docs/layers'>Layers</a>.
            </p>
        </div>
        <div :class='$style.card'>
            ...
            <p>
                <a href='/{lang}/docs/new-frame'>Create</a>, 
                <a href='/{lang}/docs/copy-frames'>Copy</a>, 
                <a href='/{lang}/docs/move-frames'>Move</a>, Drag & Delete<a href='/{lang}/docs/animation'>Frames</a>.
            </p>
        </div>
        <div :class='$style.card'>
